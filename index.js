...
const port = process.env.PORT || 9090;
  ...
  let up = `*🧑‍💻⃝𝙃𝙞𝙍𝙐𝙒𝘼 𝙈𝘿 𝘽𝙊𝙏 𝘼𝘾𝙏𝙄𝙑𝙀 𝙎𝙐𝘾𝘾𝙀𝙎𝙎𝙁𝙐𝙇𝙇➝💥♥️*\n\n*PREFIX:* ${prefix}`;
    conn.sendMessage(conn.user.id, { image: { url: `https://files.catbox.moe/ey7qsm.png` }, caption: up })
  }
  })
 ...
 if(senderNumber.includes("94704349801")){
  if(isReact) return
  m.react("🔖")
  }
